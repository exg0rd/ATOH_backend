    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(0, 'Not in work'), (1, 'In work'), (2, 'Rejected'), (3, 'Closed')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Responsible',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='client_base.status')),
            ],
            options={
                'abstract': False,
            },
